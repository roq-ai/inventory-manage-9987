  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless inventory control with Inventory Management System - your simple, affordable solution to effectively manage business inventory."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1665686310934-8fab52b3821b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxidXNpbmVzc3xlbnwwfHx8fDE2OTY5OTgwNzh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@microsoftedge?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Microsoft Edge`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless inventory control with Inventory Management System - your simple, affordable solution to effectively manage business inventory.`}
            </Text>
            <Box

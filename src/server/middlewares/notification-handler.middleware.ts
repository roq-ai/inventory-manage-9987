...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Product Addition.create': {
    roles: ['inventory-manager', 'sales-representative', 'accountant', 'business-owner'],
...
const tenantRoles: string[] = ['inventory-manager', 'sales-representative', 'accountant', 'business-owner'];
